...
// 1. Para tratar clientes concorrentemente: usar servidorConc() que cria uma goroutine para cada pedido
// 2. Quantos clientes concorrentes? Ilimitados (limitado apenas pelos recursos do sistema)
// 3. Para limitar a 10 clientes: usar pool de workers ou semáforo (implementações abaixo)
